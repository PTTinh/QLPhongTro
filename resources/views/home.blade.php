            ...
            <div class="col-12 mt-2 tab-content">
                ...
                <div class="tab-pane fade show active" id="lessee">
                    <form action="#" class="row" method="post">
                        ...
                        <div class="col-lg-6">
                            <x-app-input id="occupation" name="occupation" label="Nghề Nghiệp" placeholder="Nhập nghề nghiệp" required />
                            <x-app-input id="birth_year" name="birth_year" type="number" label="Năm Sinh" placeholder="Nhập năm sinh" required />
                            <x-app-input id="number_cccd" name="number_cccd" type="text" label="Số CCCD" placeholder="Nhập số CCCD" required />
                            <input type="file" name="cccd_front_image" id="cccd_front_image" class="form-control mb-3" required>
                            <input type="file" name="cccd_back_image" id="cccd_back_image" class="form-control mb-3" required>
                        </div>
                ...
                <div class="tab-pane fade" id="contract">
                    <form action="#" class="row" method="post">
                        ...
                        <div class="col-lg-6">
                            ...
                            <x-app-input id="other_fee" name="other_fee" type="number" label="Phí Khác" placeholder="Nhập phí khác" required />
                        </div>
                         <button type="submit" class="btn btn-primary mt-3 col-4 offset-4">
                            <i class='bx bx-save me-2'></i>
                            Lưu
